...
const MujeresDesaparecidas = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.autorizaPublicacion) {
      toast({
        title: "Autorización requerida",
        description: "Debes autorizar la publicación de la información.",
        variant: "destructive",
      });
      return;
    }
    ...
    toast({
      ...
      description: "Hemos recibido tu reporte. Nuestro equipo lo revisará pronto.",
    });
      ...
      <div className="container py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Este formulario está dirigido a todas las personas que deseen reportar la desaparición de une ser querido. 
            Tu información es valiosa y nos ayuda a crear una red de apoyo y búsqueda.
          </p>
        </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-amber-700 dark:text-amber-300">
                  Si tienes información sobre une persona desaparecida, también contacta inmediatamente a las autoridades locales. 
                  Este formulario complementa, pero no reemplaza, la denuncia oficial.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Completa la mayor cantidad de información posible. Todos los campos marcados con * son obligatorios.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-primary">Información de la persona desaparecida</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("fechaDesaparicion", e.target.value)}
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("lugarDesaparicion", e.target.value)}
                      required
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => handleInputChange("descripcionFisica", e.target.value)}
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => handleInputChange("circunstancias", e.target.value)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange("contactoRelacion", e.target.value)}
                      required
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="informacionAdicional">Información adicional que consideres relevante</Label>
                  <Textarea
              ...
              <div className="space-y-4 pt-4 border-t">
                <div className="flex items-start space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleInputChange("autorizaPublicacion", checked as boolean)}
                  />
                  <Label htmlFor="autorizacion" className="text-sm leading-relaxed">
                    Autorizo la publicación de esta información en la plataforma HerStory para ayudar en la búsqueda. 
                    Entiendo que esta información será manejada con total confidencialidad y respeto. *
                  </Label>
                </div>
              </div>
        ...
        <div className="mt-8 text-center text-sm text-muted-foreground">
          <p>
            Si necesitas ayuda para llenar este formulario o tienes preguntas, contáctanos en{" "}
            <a href="mailto:ayuda@herstory.com" className="text-primary hover:underline">
              ayuda@herstory.com
            </a>
          </p>
        </div>
